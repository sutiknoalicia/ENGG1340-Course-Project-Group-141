...
### Set-up:
Players start out by all rolling a dice to decide the turn order, with the person rolling the highest number starting first, the second highest roll going second, and so on. This turn order is consistent for the rest of the game
Players then take turns to place 1 of their troops on an unoccupied territory.
Then, players add troops to their occupied territories, until all their troops have been deployed. The troops need not be evenly distributed.
